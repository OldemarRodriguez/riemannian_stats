...
components_10d = analysis.riemannian_components_from_data_and_correlation(riemann_corr_10d)
...
# ---------------------------
iris_full = DataProcessing.load_data("./data/iris.csv", separator=";", decimal=".")
...
components_iris = analysis.riemannian_components_from_data_and_correlation(riemann_corr_iris)
print("\nriemannian_components_from_data_and_correlation:")
...
correlations_iris = analysis.riemannian_correlation_variables_components(components_iris)
print("\nriemannian_correlation_variables_components:")
